...
FFMPEG_CONFIG_MAK=1
FFMPEG_CONFIGURATION=--target-os=darwin --arch=arm64 --cc='xcrun -sdk iphoneos clang' --enable-cross-compile --enable-small --disable-debug --disable-everything --enable-protocol=file --enable-decoder=mp3 --enable-decoder=mp3float --enable-decoder=pcm_u16be --enable-decoder=pcm_u16le --enable-muxer=mp3 --enable-muxer=pcm_u16be --enable-muxer=pcm_u16le --enable-demuxer=mp3 --enable-demuxer=pcm_u16be --enable-demuxer=pcm_u16le --extra-cflags='-arch arm64 -mios-version-min=6.0 -fembed-bitcode' --extra-ldflags='-arch arm64 -mios-version-min=6.0 -fembed-bitcode' --prefix=/Users/baoyx/Documents/workspace/Github/FFmpeg-iOS/thin/arm64
prefix=/Users/baoyx/Documents/workspace/Github/FFmpeg-iOS/thin/arm64
...
CFLAGS=  -arch arm64 -mios-version-min=6.0 -fembed-bitcode -std=c99 -mdynamic-no-pic -fomit-frame-pointer -fPIC -pthread -Wdeclaration-after-statement -Wall -Wdisabled-optimization -Wpointer-arith -Wredundant-decls -Wwrite-strings -Wtype-limits -Wundef -Wmissing-prototypes -Wno-pointer-to-int-cast -Wstrict-prototypes -Wempty-body -Wno-parentheses -Wno-switch -Wno-format-zero-length -Wno-pointer-sign -Os -fno-math-errno -fno-signed-zeros -Qunused-arguments -Werror=implicit-function-declaration -Werror=missing-prototypes -Werror=return-type
CXXFLAGS=  -D__STDC_CONSTANT_MACROS
ASFLAGS=  -arch arm64 -mios-version-min=6.0 -fembed-bitcode -mdynamic-no-pic -fPIC -Qunused-arguments
AS_C=-c
AS_O=-o $@
CC_C=-c
CC_E=-E -o $@
