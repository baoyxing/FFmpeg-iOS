...
FFMPEG_CONFIG_MAK=1
FFMPEG_CONFIGURATION=--target-os=darwin --arch=armv7 --cc='xcrun -sdk iphoneos clang' --enable-cross-compile --enable-small --disable-debug --disable-everything --enable-protocol=file --enable-decoder=mp3 --enable-decoder=mp3float --enable-decoder=pcm_u16be --enable-decoder=pcm_u16le --enable-muxer=mp3 --enable-muxer=pcm_u16be --enable-muxer=pcm_u16le --enable-demuxer=mp3 --enable-demuxer=pcm_u16be --enable-demuxer=pcm_u16le --extra-cflags='-arch armv7 -mios-version-min=6.0 -fembed-bitcode' --extra-ldflags='-arch armv7 -mios-version-min=6.0 -fembed-bitcode' --prefix=/Users/baoyx/Documents/workspace/Github/FFmpeg-iOS/thin/armv7
prefix=/Users/baoyx/Documents/workspace/Github/FFmpeg-iOS/thin/armv7
...
SRC_PATH=/Users/baoyx/Documents/workspace/Github/FFmpeg-iOS/ffmpeg-2.8.3
...
CFLAGS=  -arch armv7 -mios-version-min=6.0 -fembed-bitcode -march=armv7-a -std=c99 -mdynamic-no-pic -fomit-frame-pointer -mthumb -pthread -Wdeclaration-after-statement -Wall -Wdisabled-optimization -Wpointer-arith -Wredundant-decls -Wwrite-strings -Wtype-limits -Wundef -Wmissing-prototypes -Wno-pointer-to-int-cast -Wstrict-prototypes -Wempty-body -Wno-parentheses -Wno-switch -Wno-format-zero-length -Wno-pointer-sign -Os -fno-math-errno -fno-signed-zeros -Qunused-arguments -Werror=implicit-function-declaration -Werror=missing-prototypes -Werror=return-type
CXXFLAGS=  -D__STDC_CONSTANT_MACROS
ASFLAGS=  -arch armv7 -mios-version-min=6.0 -fembed-bitcode -march=armv7-a -mdynamic-no-pic -Qunused-arguments
AS_C=-c
AS_O=-o $@
CC_C=-c
CC_E=-E -o $@
...
DOXYGEN=doxygen
LDFLAGS= -arch armv7 -mios-version-min=6.0 -fembed-bitcode  -Wl,-dynamic,-search_paths_first -Qunused-arguments
LDEXEFLAGS=
LDLIBFLAGS=
